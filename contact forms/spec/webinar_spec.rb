...
describe "request demo form" do
  ...
  it "tests_webinar_form" do 
    ...
    @form.select_dropdown(:xpath, "//*[@id='form_area_one']/fieldset[2]/label[1]/span/select", "Teacher")
    @form.select_dropdown(:xpath, "//*[@id='form_area_one']/fieldset[2]/label[2]/span/select", "ID")
